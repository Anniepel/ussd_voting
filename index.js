...
const dbConfig = {
    host: 'biutxz69v3bcxephzeja-mysql.services.clever-cloud.com',
    user: 'ukxesu2zdbsl8ko6',
    password: 'YmNNDuqmmevRfPwW73WE', // Replace with your MySQL password
    database: 'biutxz69v3bcxephzeja'
};
